...
class Youtube extends Component {
  ...
  componentDidMount() {
    fetch(
      "https://www.googleapis.com/youtube/v3/search?key=AIzaSyCPRGGFyjsIVJBp4x46u_buOZo_HcMj2zI&channelId=UCZqGjqAfTa_GLpmddGxczqA&part=snippet,id&order=date&maxResults=12"
    )
