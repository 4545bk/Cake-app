...
import logoImage from "../../../assets/template_assets/images/custom/logo.png";
          ...
          <div class="auto-container">
            <div class="inner-container">
              <div class="left-column">
                <div class="text">Enjoy the Cake while Learning</div>
                <div class="office-hour">Monday - Sunday 7:00AM - 6:00PM</div>
              </div>
              <div class="right-column">
                <div class="phone-number">
                  Baking Your Dreams Come True
                  <strong>0911940575 {"call"}
                  </strong>
                </div>
              </div>
            </div>
